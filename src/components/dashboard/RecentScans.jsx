...
import { MessageSquareWarning, Link2, Image, Mic } from "lucide-react";
    ...
    <div className="space-y-2">
      {scans.slice(0, 5).map((scan, index) => {
        ...
        return (
          ...
          >
            <div className="w-9 h-9 rounded-xl flex items-center justify-center shrink-0" style={{ background: risk.bg }}>
